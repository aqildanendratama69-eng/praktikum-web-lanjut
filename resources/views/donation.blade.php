...
<form action="/donation" method="POST" class="max-w-2xl mx-auto bg-white p-8 shadow-md rounded-lg space-y-6">
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="donor_name" placeholder="Nama Anda" class="border p-2 w-full rounded focus:ring-2 focus:ring-blue-400 outline-none" required>
        </div>
        ...
        <div>
            ...
            <textarea name="message" placeholder="Tuliskan doa dukunganmu..." class="border p-2 w-full rounded h-24 focus:ring-2 focus:ring-blue-400 outline-none"></textarea>
        </div>
    </div>
